...
GLOG_logtostderr=1 ${CODE_PATH}/computeFeatures.bin \
    ...
    -l pool5 \
    -o /home/rgirdhar/data/Work/Datasets/processed/0006_ExtendedPAL/features/CNN_pool5_fullImg_text \
    -t text \
    --ids2compute4 /home/rgirdhar/data/Work/Datasets/processed/0006_ExtendedPAL/lists/NdxesTest.txt \
