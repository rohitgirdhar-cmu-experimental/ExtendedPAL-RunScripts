...
nice -n 10 $CODE_PATH/buildIndex.bin \
    ...
    -n /srv2/rgirdhar/Work/Datasets/processed/0006_ExtendedPAL/lists/NdxesTest.txt \
    -c /srv2/rgirdhar/Work/Datasets/processed/0006_ExtendedPAL/selsearch_boxes/counts.txt \
    -s /srv2/rgirdhar/Work/Datasets/processed/0006_ExtendedPAL/search/indexes/test_250.index \
    -b 250 \
    -t 10 \
    -a 900
