...
nice -n 10 $CODE_PATH/buildIndex.bin \
    ...
    --ids2compute4 /srv2/rgirdhar/Work/Datasets/processed/0006_ExtendedPAL/lists/NdxesTrain.txt \
    -s /srv2/rgirdhar/Work/Datasets/processed/0006_ExtendedPAL/search/indexes/trainFullImg_30.index \
    -b 30 \
    -t 10 \
    -a 900
